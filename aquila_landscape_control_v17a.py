#!/usr/bin/env python3
"""Aquila landscape DWIN control panel v1.7a.
...
MAIN_ITEMS = ["PRINT", "PREPARE", "MOVE", "TEMPERATURE", "CONTROL", "STATUS", "SETTINGS", "INFO"]
...
def main() -> None:
    ...
    print("Aquila landscape control v1.7a")
